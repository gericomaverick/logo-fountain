...
import { notifyAdminConceptApproved, notifyClientConceptApproved } from "@/lib/project-lifecycle-email";
...
export async function POST(
  ...
  try {
    ...
    await Promise.all([
      notifyClientConceptApproved(project.id, result.approved.id),
      notifyAdminConceptApproved(project.id, result.approved.id),
    ]);
