...
blocks:
  - type: hero
    ...
    content: <strong>Logo Fountain</strong> is a friendly UK logo design studio for founders, sole traders and growing small businesses. Your logo is handled by dedicated designers with over 15 years of experience each, a real passion for logos, fixed prices and practical final files you can use everywhere.
    primary:
  ...
  - type: marquee
    ...
    items:
      ...
      - text: 15+ years' design experience each
        icon: x
  ...
  - type: values
    ...
    items:
      ...
      - kicker: Founder-led teams
        ...
        content: You will not be passed around a big agency team or asked to choose from dozens of random options. Your project is handled by an experienced UK designer who genuinely enjoys the detail of logo design, from the first sketch to the final file pack.
        tag: Experienced designer
  ...
  - type: work
    ...
    content: 'These sample directions show the range we design for: professional services, cafés, makers, consultants and local businesses. Each one is built around everyday use, from websites and packaging to signage and social profiles.'
    items:
      - class: work-a
  ...
  - type: packages
    ...
    content: Choose the level of logo design support that fits where your business is today. Every package includes an experienced UK designer, hand-drawn exploration, secure Stripe checkout, final logo files and clear commercial usage rights.
    items:
      - name: Essential
  ...
  - type: testimonials
    ...
    items:
      ...
      - sector: Value
        quote: We do not promise unlimited concepts or endless revisions. Instead, you get focused logo directions from seriously experienced designers, enough refinement time and honest advice about what will work.
        initials: 03
  ...
  - type: about
    ...
    content: |
      Logo Fountain is a small UK logo design studio for independent businesses, founders and practical teams who want to work directly with experienced designers. Each designer on the team brings over 15 years of professional design experience and a real interest in what makes logos memorable, usable and long-lasting.
    ...
    card:
      ...
      title: Serious design experience, delivered without the agency fuss.
      content: A simple snapshot of what makes the service different from cheaper logo makers and bigger agency processes.
      stats:
        - value: "£349"
          label: Starting package
        - value: "15+"
          label: Years' experience each
        - value: "10+"
  ...
  - type: faq
    ...
    items:
      ...
      - question: Are all your designers based in the UK?
        answer: Logo Fountain is built as a UK-led logo design service for UK businesses, with experienced designers who each bring over 15 years of professional design experience.
      ...
      - question: Why not use an AI logo maker?
        answer: A logo maker can be useful for quick experiments, but it will not understand your business, audience, positioning or future use cases in the same way an experienced designer can. It can also create questions around originality and usage rights. We are a better fit when you want something considered and yours.
...
meta:
  ...
  desc: Friendly bespoke logo design for UK small businesses. Experienced designers, hand-drawn concepts, fixed packages from £349 and final files ready for web and print.
---
